...
st.markdown("""
    <style>
        ...
        .container { max-width: 900px; margin: auto; padding: 20px; background: white; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); text-align: center; }
    ...
    <div class='container'>
        <h1>📚 Personal Library Instructor</h1>
    </div>
